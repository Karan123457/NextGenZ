      ...
      <div className="sem1-container">
        ...
        >
          <div className="hero-content">
            ...
            >
              This 4th Semester material has been carefully prepared to help
        ...
        >
          सभी 4th Semester के छात्रों के लिए इन 4 विषयों की External Exam में
        ...
        <p className="pyq-intro">
          यहाँ आप Jharkhand Polytechnic Diploma 4th के मुख्य विषयों के{" "}
        ...
        {years.map((year) => (
          <div key={year} className="year-box">
            <h3>{year} Question Paper – 4th Semester</h3>
