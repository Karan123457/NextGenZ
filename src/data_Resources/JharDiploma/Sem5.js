      ...
      <div className="sem1-container">
        ...
        >
          <div className="hero-content">
            ...
            >
              This 5th Semester material has been carefully prepared to help
        ...
        >
          सभी 5th Semester के छात्रों के लिए इन 4 विषयों की External Exam में
        ...
        <p className="pyq-intro">
          यहाँ आप Jharkhand Polytechnic Diploma 5th के मुख्य विषयों के{" "}
        ...
        {years.map((year) => (
          <div key={year} className="year-box">
            <h3>{year} Question Paper – 5th Semester</h3>
