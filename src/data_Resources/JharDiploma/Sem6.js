    ...
    return (
        ...
        >
            <h2 style={{ color: "#0d6efd", marginBottom: "12px" }}>
                📘 Diploma 6th Semester Jharkhand (JUT Ranchi)
            </h2>
            <p style={{ marginBottom: "16px" }}>
                This 6th Semester material has been carefully prepared to help Jharkhand Polytechnic Diploma students prepare effectively for their examinations. <br />
            ...
            >
                <h4 style={{ color: "#198754", marginBottom: "15px", fontWeight: 600, fontSize: "1.2rem" }}>
                    📝 Subjects of 6th Semester Jharkhand (Total 4):
                </h4>
               ...
               <p style={{ marginTop: "16px" }}>
                सभी 6th Semester के छात्रों के लिए इन 4 विषयों की External Exam में उपस्थित होना अनिवार्य है। अंतिम परीक्षा का प्रश्नपत्र JUT Ranchi द्वारा तैयार किया जाता है।
             </p>
                ...
                {[2024, 2023, 2022, 2021].map((year) => (
                    ...
                    >
                        <h2 style={{ textAlign: "center", color: "#0d6efd", fontWeight: 600, marginBottom: 20, fontSize: "1.5rem" }}>
                            {year} Question Paper 6th Semester
                        </h2>
