      ...
      <div className="sem1-container">
        ...
        >
          <div className="hero-content">
            ...
            >
              This 3rd Semester material has been carefully prepared to help
        ...
        >
          सभी 3rd Semester के छात्रों के लिए इन 4 विषयों की External Exam में
        ...
        <p className="pyq-intro">
          यहाँ आप Jharkhand Polytechnic Diploma 3rd के मुख्य विषयों के{" "}
        ...
        {years.map((year) => (
          <div key={year} className="year-box">
            <h3>{year} Question Paper – 2nd Semester</h3>
