// Frontend/src/data_Exam/Bihar/Bihar LE/DetailsPageBRB.js
import React, { useState } from "react";

import PhysicsQuestionsBRB from "./PhysicsQuestionsBRB";
import ChemistryQuestionsBRB   from "./ChemistryQuestionsBRB";
import MathematicsQuestionsBRB from "./MathematicsQuestionsBRB";
// import Analysis from "./Analysis"; // optional later

export default function BiharLEDetailsPage() {
    ...
    z-index:50;
      ...
      {!focusMode && (
        <div className="pyq-header">
          <h1>Bihar BCECE LE Previous Year Questions (PYQ)</h1>
      ...
      <div className="pyq-card">
        {activeTab === "Physics" && (
          <PhysicsQuestionsBRB setFocusMode={setFocusMode} />
        )}
        {activeTab === "Chemistry" && (
          <ChemistryQuestionsBRB setFocusMode={setFocusMode} />
        )}

        {activeTab === "Math" && (
          <MathematicsQuestionsBRB setFocusMode={setFocusMode} />
        )}
      ...
      {!focusMode && (
        <div className="pyq-seo">
          <h2>Bihar BCECE LE Previous Year Question Papers</h2>
         Prepare for the <strong>Bihar BCECE Lateral Entry Exam 2026</strong>
          with our comprehensive collection of previous year question papers from 2021 to 2025.
        </div>
      )}
    </div>
  );
