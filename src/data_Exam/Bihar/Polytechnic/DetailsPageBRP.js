    ...
    z-index:50;
      ...
      {!focusMode && (
        <div className="pyq-header">
          <h1>Bihar Polytechnic Previous Year Questions (PYQ)</h1>
      ...
      {!focusMode && (
        <div className="pyq-seo">
          <h2>Bihar Polytechnic Previous Year Question Papers</h2>
          <p>
            Prepare for the <strong>Bihar Polytechnic Exam 2026</strong>
