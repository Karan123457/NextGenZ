...
export default function MathematicsQuestions({ backToYearList }) {
  const years = [
  ...
  const questionsByYear = {
    "2025 Questions": [
      { id: "2025-q1", text: "Derivative of x²?", options: ["2x","x","x²","1"], correctIndex: 0 },
      { id: "2025-q2", text: "Integral of 1/x?", options: ["ln|x|","x","1/x²","e^x"], correctIndex: 0 },
      { id: "2025-q3", text: "Value of sin(90°)?", options: ["1","0","0.5","√2/2"], correctIndex: 0 },
      { id: "2025-q4", text: "Solve x² - 4 = 0", options: ["x=2 or -2","x=4","x=-4","x=0"], correctIndex: 0 },
      { id: "2025-q5", text: "Sum of first 5 natural numbers?", options: ["15","10","20","25"], correctIndex: 0 },
      { id: "2025-q6", text: "Factorial of 4?", options: ["24","4","16","12"], correctIndex: 0 },
    ],
    "2024 Questions": [
      { id: "2024-q1", text: "Derivative of sin(x)?", options: ["cos(x)","sin(x)","-sin(x)","-cos(x)"], correctIndex: 0 },
      { id: "2024-q2", text: "Integral of cos(x)?", options: ["sin(x)","cos(x)","-cos(x)","-sin(x)"], correctIndex: 0 },
      { id: "2024-q3", text: "Value of cos(0°)?", options: ["1","0","0.5","-1"], correctIndex: 0 },
    ],
  ...
  return (
    <div className="physics-box">
      <h5 className="section-title">Mathematics Previous Year Questions</h5>
