...
import PhysicsQuestionsJHP from "./PhysicsQuestionsJHP";
import ChemistryQuestions from "./ChemistryQuestionsJHP";
import MathematicsQuestions from "./MathematicsQuestionsJHP";
  ...
  .pyq-header{
    ...
    z-index:50;
      ...
      <div className="pyq-card">
        {activeTab === "Physics" && (
          <PhysicsQuestionsJHP setFocusMode={setFocusMode} />
        )}
        {activeTab === "Chemistry" && (
